  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return DynamicColorBuilder(
      builder: (lightDynamic, darkDynamic) {
        final theme = PhoenixBranding.buildTheme(
          branding: branding,
...
class _GlobalAppShell extends StatelessWidget {
  const _GlobalAppShell({
    required this.branding,
    required this.child,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final scaledTextTheme = Theme.of(context).textTheme.apply(
          fontSizeFactor: mediaQuery.size.shortestSide >= 600 ? 1.08 : 1.0,
        );
