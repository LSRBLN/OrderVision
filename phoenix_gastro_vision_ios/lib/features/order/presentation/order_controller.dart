...
class OrderController extends FamilyNotifier<OrderState, int> {
  ...
  Future<PrintResult> sendToKitchen({String? waiterName}) async {
    ...
    final ticket = KitchenTicketData(
      ...
      waiterName:
          waiterName ?? (demoMode.enabled ? demoMode.operatorName : null),
      ...
      trainingMode: demoMode.enabled,
      paymentMethodLabel: demoMode.enabled ? 'Demo order routing' : null,
      exchangeRateInfo: demoMode.enabled
